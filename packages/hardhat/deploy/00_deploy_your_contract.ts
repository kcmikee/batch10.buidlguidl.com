...
const ADDRESS_BATCH_REGISTRY = "0x0e51b39aa58887b43c14E9C831E77eE52BA38A29";
/**
...
const deployYourContract: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  */
  ...
  const res = await deploy("CheckIn", {
    from: deployer,
    // Contract constructor arguments
    args: [ADDRESS_BATCH_REGISTRY],
    log: true,
  ...
  console.log("BatchCheckin deployed to:", res.address, "\n");
};
...
deployYourContract.tags = ["BatchCheckIn"];
